...
class Group(Base):
    ...
    owner_id       = Column(String, ForeignKey("user.user_id"), nullable=False, index=True)
...
class Person(Base):
    ...
    group_id      = Column(String, ForeignKey("group.group_id"), index=True, nullable=False)
...
class RoleOfPerson(Base):
    ...
    no            = Column(Integer, primary_key=True, autoincrement=True)
    person_hash   = Column(String, ForeignKey("person.person_hash"), index=True, nullable=False)
...
class Role(Base):
    ...
    no            = Column(Integer, primary_key=True, autoincrement=True)
    group_id      = Column(String, ForeignKey("group.group_id"), index=True, nullable=False)
    role_id       = Column(String, unique=True, index=True, nullable=False) # auto creation
...
class RoleGroup(Base):
    ...
    no              = Column(Integer, primary_key=True, autoincrement=True)
    group_id        = Column(String, ForeignKey("group.group_id"), index=True, nullable=False)
    role_group_id   = Column(String, unique=True, index=True, nullable=False) # auto creation
...
class CommandAfterConfirm(Base):
    ...
    command_id     = Column(String, unique=True, index=True, nullable=False) # auto creation
...
class AllowedDeviceInGroup(Base):
    ...
    no            = Column(Integer, primary_key=True, autoincrement=True)
    group_id      = Column(String, ForeignKey("group.group_id"), index=True, nullable=False)
    device_id     = Column(String, unique=True, nullable=False, index=True) # auto creation
